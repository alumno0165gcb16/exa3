...
function Comienza() {
	...
	wachID = navigator.accelerometer.watchAcceleration(Correcto,Error, opciones);
...
function Detente() {
	...
	// Error: Falla al obtener la caeleracion
	//
	function Error() {
		alert('Error!');
	}
	// Exito al localizar
	 ...
	 function Localiza(posicion) {
		 ...
		 'Velocidad: '  + psicion.coords.speed + '<br />' +
		 'Intervalo: ' + posicion.timestamp + '<br />' ;
		 
		 // Error de la geolocalizacion
		 //
